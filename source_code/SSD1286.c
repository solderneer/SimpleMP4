...
void LCDDEV_Init(unsigned int InitType)
{
    ...
    LCDDEV_Reg_Set(0x0007, 0x0233);

    LCDDEV_Reg_Set(0x0000, 0x0001);

    LCDDEV_Reg_Set(0x0010, 0x0012);

    LCDDEV_Reg_Set(0x0011, 0x0014);
    LCDDEV_Reg_Set(0x0012, 0x0509);
    LCDDEV_Reg_Set(0x0013, 0x2B00);

    LCDDEV_Reg_Set(0x001E, 0x0131);
    

    LCDDEV_Reg_Set(0x0001, 0x2A9F);

    LCDDEV_Reg_Set(0x0002, 0x0380);
    
    if(InitType == LCD_INIT_NORMAL)
        LCDDEV_Reg_Set(0x0003, 0x6030);
    else if((InitType == LCD_JPEG_X_INIT)||(InitType == LCD_MP4_INIT))
        LCDDEV_Reg_Set(0x0003, 0x6038);
    
    LCDDEV_Reg_Set(0x0004, 0x0000);
    LCDDEV_Reg_Set(0x0005, 0x0000);

    LCDDEV_Reg_Set(0x0016, 0x7F00);
    LCDDEV_Reg_Set(0x0017, 0x0101);

    LCDDEV_Reg_Set(0x0007, 0x0233);
    
    LCDDEV_Reg_Set(0x0040, 0x0001);
    LCDDEV_Reg_Set(0x0041, 0x0000);
    LCDDEV_Reg_Set(0x0042, 0x9F00);
    LCDDEV_Reg_Set(0x0043, 0x9F00);
    LCDDEV_Reg_Set(0x0044, 0x7F00);
    LCDDEV_Reg_Set(0x0045, 0x9F00);

    LCDDEV_Reg_Set(0x002C, 0x3000);

    LCDDEV_Reg_Set(0x0030, 0x0000);
    LCDDEV_Reg_Set(0x0031, 0x0000);
    LCDDEV_Reg_Set(0x0032, 0x0000);
    LCDDEV_Reg_Set(0x0033, 0x0000);
    LCDDEV_Reg_Set(0x0034, 0x0000);
    LCDDEV_Reg_Set(0x0035, 0x0000);
    LCDDEV_Reg_Set(0x0036, 0x0000);
    LCDDEV_Reg_Set(0x0037, 0x0000);
    LCDDEV_Reg_Set(0x003A, 0x0000);
    LCDDEV_Reg_Set(0x003B, 0x0000);
    
    LCDDEV_Reg_Set(0x0021, 0x0000);
    LCD_Command(0x0022);
...
void LCDDEV_Init(unsigned int InitType)
{
    ...
    if(InitType == LCD_INIT_NORMAL)
        ...
        LCDDEV_Reg_Set(0x0001, 0x2B9F);

    LCDDEV_Reg_Set(0x0002, 0x0700);

    //LCDDEV_Reg_Set(0x0003, 0x6830);
    if(InitType == LCD_INIT_NORMAL)
        LCDDEV_Reg_Set(0x0003, 0x6030);
    else if((InitType == LCD_JPEG_X_INIT)||(InitType == LCD_MP4_INIT))
        LCDDEV_Reg_Set(0x0003, 0x6038);
    ...
    LCDDEV_Reg_Set(0x0041, 0x0000);
    LCDDEV_Reg_Set(0x0042, 0x9F00);
    LCDDEV_Reg_Set(0x0043, 0x0000);
    LCDDEV_Reg_Set(0x0044, 0x8102);
    LCDDEV_Reg_Set(0x0045, 0x9F00);
...
void LCDDEV_Init(unsigned int InitType)
{
    LCDDEV_Reg_Set(0x0007, 0x0233);       // Display control

    LCDDEV_Reg_Set(0x0000, 0x0001);

    LCDDEV_Reg_Set(0x000B, 0x5C08);

    LCDDEV_Reg_Set(0x0010, 0x11D2);
    
    LCDDEV_Reg_Set(0x0011, 0x001C);
...
void LCD_SetDispAddr(int x, int y)
{
    unsigned int gddram;
    //x += 2;
    gddram = ((y&0xFF)<<8) | ((x&0x7F)+2);
	LCDDEV_Reg_Set(0x21, gddram);
	LCD_Command(0x22);
}
...
void LCDDEV_SetWindow(int x0, int y0, int x1, int y1)
{
    ...
    waddr = (((x1&0x7F)+2)<<8) | ((x0&0x7F)+2);
	LCDDEV_Reg_Set(0x44, waddr);
	
	waddr = ((y1&0xFF)<<8) | (y0&0xFF);
	LCDDEV_Reg_Set(0x45, waddr);
	
	waddr = ((y0&0xFF)<<8) | ((x0&0x7F)+2);
	LCDDEV_Reg_Set(0x21, waddr);
